...
Version numbering is used to communicate the scale and impact of changes in a document, tool, or dataset.

- **Format:** `v[MAJOR].[MINOR].[PATCH]`

Version components are defined as:

- **MAJOR**  
  Significant structural or calculation changes, including redesigns or new methodologies.  
  Impacts how results are produced.

- **MINOR**  
  Incremental structural updates or calculation adjustments, such as adding fields or refining logic.  
  Extends or modifies existing functionality without full redesign.

- **PATCH**  
  Cosmetic or non-functional updates, including text edits, formatting, or corrections.  
  Does not affect calculations or outputs.

Version selection is determined by impact:

- Changes affecting **outputs or logic** → MAJOR  
- Changes adjusting or extending **structure or behaviour** → MINOR  
- Changes limited to **presentation or wording** → PATCH
