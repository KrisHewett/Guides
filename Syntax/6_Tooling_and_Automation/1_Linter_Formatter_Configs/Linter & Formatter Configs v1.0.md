...
**SSOT Path:** <https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/Linter_Formatter_Configs_v1.1.md>

---

## **Purpose**

Provide standard configurations to enforce formatting, style, and accessibility across codebases.

---

> This document provides **configuration files and settings** for each language, matching the numbering used in the Language-specific Examples:
...
## **SSOT Storage Guidance**

Save these configuration files using **full absolute paths** per SSOT directives:

```text
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/python/pyproject.toml
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/javascript/.eslintrc.json
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/javascript/.prettierrc
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/powershell/PSScriptAnalyzerSettings.psd1
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/c_cpp/clang-format.yaml
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/csharp/.editorconfig
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/dax/BestPracticeAnalyzer.rules.json
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/powerquery/vscode_settings.json
https://github.com/KrisHewett/Guides/Linter_Formatter_Configs/configs/sql/.sqlfluff
```
...
| 1.1     | 2026-01-14 | K. Hewett | Added SSOT storage guidance and extended configs  |
...
- SSOT path updated to new folder structure.
