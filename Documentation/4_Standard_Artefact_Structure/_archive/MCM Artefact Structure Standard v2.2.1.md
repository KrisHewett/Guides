...
Conforms To Directive: MCM Artefact Structure Standard v2.2.1

SSOT Path: \\Guides\3_Structural_Rules_and_Metadata\4_Standard_Artefact_Structure\Artefact_Structure_Standard_v2.2.1.md
...
artefacts under the Master Compliance Memory (MCM). Version 2.2.1 applies a patch to harmonise with MCM Directives
v56.2.2, adds ASCII-only formatting rules, expands markdownlint coverage, hardens SSOT requirements, and introduces
the explicit Table Formatting Standard.
...
| Version | Date       | Author                        | Changes                                                                                  |
|---------|------------|-------------------------------|------------------------------------------------------------------------------------------|
| 2.2.1   | 2026-02-27 | <Kristopher.Hewett@sa.gov.au> | Patch: ASCII-only; MD001-MD060 full rule; table formatting standard; SSOT rule hardening |
| 2.2.0   | 2026-02-27 | <Kristopher.Hewett@sa.gov.au> | Minor: Added MD060 table standard; updated formatting and metadata rules                 |
