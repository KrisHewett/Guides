...
**SSOT Path:** <https://github.com/KrisHewett/Guides/Syntax_Guideline/Universal_Syntax_Guideline_v1.6.md>
...
- Characters such as ≤, ≥, ÷, and & can be auto‑escaped in some editors.
- Browser-based editors (e.g., Edge, Copilot panes) may rewrite characters inside Markdown inputs.
- When authoring documentation tables, prefer ASCII equivalents (<=, >=, /, and).
- Copilot and automated markdownlint validation tools may enforce ASCII-only formatting for artefacts.

> For human awareness — not enforced as coding rules
> This section is informational, not a mandatory coding rule.
...
| 1.6     | 2026-02-06 | K. Hewett | Added Notes on Special Characters    |
...
- SSOT path aligned; lists and rules follow MD032.
- Horizontal rules MD035 applied.
